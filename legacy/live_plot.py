...
port = 54321
# port = 45454
# Activity monitor port = 51892
# Matlab monitor port = 54320

# Create a socket which is used to connect to Sessantaquattro
sq_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)  # AF_INET: IPv4 Socket, SOCK_STREAM: TCP socket
